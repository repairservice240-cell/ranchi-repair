  ...
  return (
    <section className="w-full bg-white overflow-hidden relative">
      ...
      >
        ...
        {/* Live Blinking / Pulsing "Book a Service Now" Button Overlay */}
        <div className="absolute left-[3.2%] sm:left-[4%] md:left-[4.5%] bottom-[7.5%] sm:bottom-[9%] md:bottom-[10.5%] lg:bottom-[11%] z-20">
          <button
            onClick={() => onOpenBooking?.()}
            id="hero-blinking-book-btn"
            className="inline-flex items-center justify-center gap-1.5 sm:gap-2.5 px-3.5 sm:px-6 md:px-7 py-2 sm:py-3 md:py-3.5 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-extrabold rounded-full text-[11px] sm:text-sm md:text-base shadow-xl shadow-orange-500/30 transition-all animate-pulse cursor-pointer border border-white/30"
          >
